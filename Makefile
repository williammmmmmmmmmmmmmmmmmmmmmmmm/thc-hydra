STRIP=strip
XDEFINES= -DLIBOPENSSL -DLIBNCURSES -DHAVE_PCRE -DLIBPOSTGRES -DHAVE_ZLIB -DHAVE_MATH_H 
XLIBS= -lz -lcurses -lssl -lpcre2-8 -lpq -lcrypto
XLIBPATHS=-L/usr/lib -L/usr/local/lib -L/lib -L/lib/x86_64-linux-gnu
XIPATHS= -I/usr/include -I/usr/include -I/usr/include/postgresql
PREFIX=/usr/local
XHYDRA_SUPPORT=
STRIP=strip
